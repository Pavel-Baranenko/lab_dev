...
function header(parent) {
  ...
  avatar.addEventListener('click', () => {
    if (document.querySelector('.lab-header-menu')) {
      ...
      profPic.setAttribute('src', "/content/sections/dash/img/profile.svg")
      ...
      plansPic.setAttribute('src', "/content/sections/dash/img/plans.svg")
      ...
      LogPic.setAttribute('src', "/content/sections/dash/img/logout.svg")
    }
  })
}
...
function profile() {
  ...
  profileBtn.addEventListener('click', () => {
    ...
    editName.setAttribute('src', "/content/sections/profile/img/edit.svg")
    ...
    editMail.setAttribute('src', "/content/sections/profile/img/edit.svg")
  })
