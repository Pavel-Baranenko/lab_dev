...
class DesignConstructor {
  ...
  static generalStyles(item, parent) {
    ...
    const padding = lab_design_system_d('strong', 'padding-box-label', parent, 'padding')

    const paddingBox = lab_design_system_d('div', "padding-box", parent, '', '', ['design', 'grid-box'])
    const margin = lab_design_system_d('strong', 'margin-box-label', parent, 'margin')
    ...
    const attributesLabel = lab_design_system_d('strong', 'attributes-label', parent, 'attributes')
    ...
    const attributes = lab_design_system_d('div', 'attributes', parent)
    const attributesBox = lab_design_system_d('div', 'attributes-add-box', parent, '', '', ['design', 'styleBox'])
    const addlabel = lab_design_system_d('span', 'attributes-add-label', attributesBox, 'add attribute')
    const addAtBtn = lab_design_system_d('button', 'attributes-add-btn', attributesBox, '+')
    ...
    function addAttribute() {
      let id = Designer.ID()
      const wrap = lab_design_system_d('div', id, attributes, '', '', ['design', 'styleBox'])
      wrap.style.marginBottom = '10px'
      wrap.style.gap = '10px'

      const nameWrap = lab_design_system_d('div', `${id}-name-wrap`, wrap, '', '', ['design', 'inputWrap'])
      const name = lab_design_system_d('input', `name-${id}`, nameWrap, '', '', ['design', 'input'])

      const inputWrap = lab_design_system_d('div', `${id}-input-wrap`, wrap, '', '', ['design', 'inputWrap'])
      const input = lab_design_system_d('input', `input-${id}`, inputWrap, '', '', ['design', 'input'])
...
function design_mode(app) {
  ...
  function addList(e, list) {
    Object.keys(e).map(el => {
      ...
      const text = lab_design_system_d('span', Designer.ID(), item, el)
  ...
  function OpenList(componentGroup) {
    ...
    function RenrerComponentsList() {
      const listing = lab_design_system_d('div', 'template-list', menu, '', 'scrollable', ['design', 'templateList'])
  ...
  const homeBtn = lab_design_system_d('a', "top-home", topSettings, '', '', ['design', 'btn'])
  const homeBtnIcon = lab_design_system_d('img', "top-home-icon", homeBtn, '', '', ['design', 'icon'])
  homeBtn.setAttribute('href', `/`)
  homeBtnIcon.setAttribute('src', `${oldSrc}back-icon.svg`)
      ...
      function StyleSection(param) {
        ...
        if (param == 'styles') {
          ...
          cssBox.addEventListener('input', () => {
            ...
            socket.emit('saveCSS', userLSG, res => { })
          })
